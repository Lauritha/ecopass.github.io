...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2017/10/12', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounter"><span>+1000</span><span> Eventos</span></div>'
			+ '<div class="tg-eventcounter"><span>+468</span><span>Productores</span></div>'
			+ '<div class="tg-eventcounter assistants"><span>+2.5m</span><span>Personas Acreditadas</span></div>'
		));
	});
	/* -------------------------------------
			NEXT EVENT COUNTER
